...
public class HomepageController extends  Controller{
    ...
    public HomepageController(HomepageView view) {
        ...
        this.view.getNewGameBtn().addActionListener(e -> {
            ...
            Board board = new Board(level.getHeight(), level.getWidth(), level.getTileConfig(), level.getShape() == 'S',false);
        ...
        this.view.getEditGameBtn().addActionListener(e->{
            Level level = new Level(view.getSelectedLevel());
            Board board = new Board(level.getHeight(), level.getWidth(), level.getTileConfig(), level.getShape() == 'S',true);
